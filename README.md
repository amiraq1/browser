...
- **صفحة الإعدادات:** تحكم كامل بتفعيل/تعطيل المانع، تنظيف يدوي للإعلانات، وتصفير العداد.
